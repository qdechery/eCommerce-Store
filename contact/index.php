...
if ($_SERVER["REQUEST_METHOD"] == "POST") {	
	...
	if ($name == "" OR $email == "" OR $message == "") {
		$error_message = "You must provide a name, email, and message.";
	}
	...
	if(!isset($error_message)) {
		...
		if($mail->Send()) {
			...
			$error_message = "There was a prolem sending the email: " . $mail->ErrorInfo;
		} 
	}
	...
	<div class="section page">
		...
		<div class="wrapper">
			...
			<?php if (isset($_GET["status"]) AND $_GET["status"] == "thanks") { ?>
				<p class="thanks">Thanks for the email! I&rsquo;ll be in touch shortly.</p>
			<?php } else { ?>
				<?php
					if (!isset($error_message)) {
				...
				<form method="post" action="<?php echo BASE_URL; ?>contact/">
					<table>
						...
						<tr>
							...
							<td>
								<p>Send me a copy of the email.</p>
							</td>
						</tr>
